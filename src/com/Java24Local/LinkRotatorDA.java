...
public class LinkRotatorDA extends JFrame
    ...
    public LinkRotatorDA() {
        ...
        pageLink[0] = getURI("http://www.bestbuy.com");
        pageLink[1] = getURI("http://www.msn.com");
        pageLink[2] = getURI("http://www.motortrend.com");
